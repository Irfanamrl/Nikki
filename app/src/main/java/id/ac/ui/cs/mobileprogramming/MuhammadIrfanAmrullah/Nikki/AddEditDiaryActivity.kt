...
class AddEditDiaryActivity : AppCompatActivity() {
    companion object {
        var EXTRA_ID : String = "ic.ac.ui.cs.mobileprogramming.MuhammadIrfanAmrullah.id.ac.ui.cs.mobileprogramming.MuhammadIrfanAmrullah.Nikki.EXTRA_ID"
        var EXTRA_TITLE : String = "ic.ac.ui.cs.mobileprogramming.MuhammadIrfanAmrullah.id.ac.ui.cs.mobileprogramming.MuhammadIrfanAmrullah.Nikki.EXTRA_TITLE"
        var EXTRA_DESCRIPTION : String = "ic.ac.ui.cs.mobileprogramming.MuhammadIrfanAmrullah.id.ac.ui.cs.mobileprogramming.MuhammadIrfanAmrullah.Nikki.EXTRA_DESCRIPTION"
        var EXTRA_LOCATION : String = "ic.ac.ui.cs.mobileprogramming.MuhammadIrfanAmrullah.id.ac.ui.cs.mobileprogramming.MuhammadIrfanAmrullah.Nikki.EXTRA_LOCATION"
        var EXTRA_URI : String = "ic.ac.ui.cs.mobileprogramming.MuhammadIrfanAmrullah.id.ac.ui.cs.mobileprogramming.MuhammadIrfanAmrullah.Nikki.EXTRA_URI"
        var EXTRA_EMOTION : String = "ic.ac.ui.cs.mobileprogramming.MuhammadIrfanAmrullah.id.ac.ui.cs.mobileprogramming.MuhammadIrfanAmrullah.Nikki.EXTRA_EMOTION"
        //image pick code
